...
relatedDestinations: ["samana", "las-terrenas"]
readingTime: 9
draft: false
---
...
**What to look for:**
- IWC (International Whaling Commission) compliance — licensed operators follow approach protocols that protect the whales and produce better sightings
- Boats with hydrophones — the ability to hear whale song underwater transforms the experience from visual to multi-sensory
- Small group sizes — boats with 20-30 passengers see better behavior than the large catamaran tours carrying 80+
- Marine biologist or naturalist guides — commentary that explains what you are watching is enormously valuable

**Practical booking:**
Tours depart from the Samaná town waterfront every morning, typically 8am to 9am. The standard duration is half a day (3-4 hours). Prices run RD$4,000-6,500 (~$68-110 USD) per person for quality operators.
...
- **Breaching:** Full-body leaps out of the water, sometimes repeated many times in sequence. The most dramatic display — the sound when a 30,000 kg animal lands is extraordinary.
- **Tail slaps:** The fluke (tail) raised and slapped against the water, creating a visible impact and audible report across the bay. A form of communication.
- **Spy-hopping:** The whale raises its head vertically out of the water, apparently looking around. Genuinely curious behavior.
- **Blow:** The visible spout of moist air and water as whales surface to breathe — the first indicator of a whale's position from a distance.
