...
heroImage: ""
tagline: "The Wild, Untouched Southwest"
region: "interior"
...
budgetPerDay:
  ...
  midRange: 5500
  luxury: 14000
gettingThere: "Drive from Santo Domingo (3-3.5 hours) via Highway 2 west through San Cristóbal and Baní, then south along the coast. The María Montez International Airport (BRX) in Barahona receives limited domestic flights. Most visitors drive or arrange private transport from the capital."
essentials:
  - { icon: "🌡️", label: "Climate", value: "Hot and dry — semi-arid southwest coast" }
  - { icon: "💵", label: "Budget", value: "RD$2,000-14,000/day (~$34-$240 USD)" }
  - { icon: "🗣️", label: "Language", value: "Spanish (minimal English)" }
  - { icon: "🏝️", label: "Vibe", value: "Remote, undeveloped, raw Caribbean" }
highlights:
  - "Stand on the pristine white sand of Bahía de las Águilas, the most beautiful beach in the Dominican Republic"
  - "See American crocodiles and rhinoceros iguanas at Lago Enriquillo, the largest lake in the Caribbean"
  - "Visit the only Larimar mines in the world, tucked into the mountains above the coast"
  - "Drive the spectacular coastal road from Barahona to Pedernales, hugging cliffs above turquoise water"
  - "Experience a corner of the Dominican Republic that mass tourism has not yet reached"
...
affiliatePicks:
  - name: "Casa Bonita Tropical Lodge"
    type: "hotel"
    price: "RD$12,000/night (~$205 USD)"
    personalNote: "The best accommodation in the region by a wide margin. Perched on a hillside above the coast with infinity pool views to the sea. The food is outstanding and the staff arrange excursions to every major attraction. Worth the splurge."
    affiliateUrl: "#"
  - name: "Bahía de las Águilas Boat Excursion"
    type: "tour"
    price: "RD$3,000 (~$51 USD) per boat"
    personalNote: "Book through your hotel or find a boatman in Las Cuevas. The ride takes about 20 minutes each way and the boat drops you on the beach. Arrange a pickup time — there is no shade and no way to leave otherwise. Bring everything."
    affiliateUrl: "#"
  - name: "Lago Enriquillo Guided Tour"
    type: "tour"
    price: "RD$2,500 (~$42 USD) per person"
    personalNote: "The lake is vast and you need a guide to reach Isla Cabritos where the crocodiles and iguanas are. The boat tour takes about two hours and the wildlife sightings are virtually guaranteed. Go early in the morning before the heat becomes brutal."
    affiliateUrl: "#"
