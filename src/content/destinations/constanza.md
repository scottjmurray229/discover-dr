...
budgetPerDay:
  ...
  midRange: 5000
  luxury: 12000
gettingThere: "Drive from Santo Domingo (2.5-3 hours) via the Autopista Duarte to Bonao, then take the dramatic mountain road through Casabito. Alternatively, approach from Jarabacoa (1.5 hours) via a rough but scenic mountain road. No direct flights — nearest airports are Santo Domingo (SDQ) and Santiago (STI)."
essentials:
  - { icon: "🌡️", label: "Climate", value: "Cool highland — 10-22°C (50-72°F), frost possible" }
  - { icon: "💵", label: "Budget", value: "RD$1,800-12,000/day (~$31-$205 USD)" }
  - { icon: "🗣️", label: "Language", value: "Spanish (very limited English)" }
  - { icon: "⛰️", label: "Elevation", value: "1,200 meters (3,940 ft)" }
highlights:
  - "Walk through strawberry fields and vegetable farms at the highest cultivated valley in the Caribbean"
  - "Drive through the otherworldly alpine landscape of Valle Nuevo National Park"
  - "Camp under some of the clearest night skies in the Dominican Republic"
  - "Visit the Aguas Blancas waterfall, the tallest cascade in the Cordillera Central"
  - "Experience the only place in the Caribbean where frost forms and temperatures drop below freezing"
gradientColors: "from-emerald-900 via-green-800 to-lime-900"
relatedDestinations:
  - "jarabacoa"
  - "barahona"
faqItems:
  - { question: "How cold does Constanza actually get?", answer: "Constanza is the coldest town in the Caribbean. Daytime temperatures typically range from 18-22°C (64-72°F), but nights regularly drop to 8-12°C (46-54°F). In December and January, temperatures can fall below freezing at higher elevations, and frost on the fields is common in early morning. Valle Nuevo has recorded temperatures as low as -5°C (23°F). Pack warm layers, a jacket, and long pants." }
...
affiliatePicks:
  - name: "Hotel Altocerro Villas"
    type: "hotel"
    price: "RD$6,500/night (~$111 USD)"
    personalNote: "Mountain cabins with fireplaces and sweeping valley views. On cold nights, the fireplace is not decorative — you actually need it. The restaurant serves excellent Dominican mountain cuisine."
    affiliateUrl: "#"
  - name: "Valle Nuevo 4x4 Excursion"
    type: "tour"
    price: "RD$5,000 (~$85 USD) per person"
    personalNote: "A local guide with a proper 4x4 is the best way to experience Valle Nuevo. The park roads are rough and easy to get lost on. The guide I used knew every viewpoint and had stories about the ecology that made the trip far richer."
    affiliateUrl: "#"
  - name: "Strawberry Farm Tour"
    type: "activity"
    price: "RD$500 (~$8.50 USD)"
    personalNote: "Several farms near town let you walk the fields and pick your own. The farmers are proud of their work and happy to explain the growing process. You leave with a bag of the freshest strawberries you have ever tasted."
    affiliateUrl: "#"
