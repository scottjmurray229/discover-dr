...
budgetPerDay:
  ...
  midRange: 6000
  luxury: 15000
gettingThere: "Drive 1.5 hours from Santiago or 2.5 hours from Santo Domingo via the Autopista Duarte (Highway 1) north to La Vega, then Highway 28 into the Cordillera Central. No direct flights — the nearest airports are Santiago (STI) and Santo Domingo (SDQ)."
essentials:
  - { icon: "🌡️", label: "Climate", value: "Cool highland — 15-25°C (59-77°F) year-round" }
  - { icon: "💵", label: "Budget", value: "RD$2,000-15,000/day (~$34-$255 USD)" }
  - { icon: "🗣️", label: "Language", value: "Spanish (limited English)" }
  - { icon: "⛰️", label: "Elevation", value: "530 meters (1,740 ft)" }
highlights:
  - "Trek to the summit of Pico Duarte, the highest peak in the Caribbean at 3,098 meters"
  - "Raft the Río Yaque del Norte, the longest river in the Dominican Republic"
  - "Stand beneath the thundering 120-foot cascade at Salto de Jimenoa"
  - "Cool off in mountain river pools surrounded by pine forests and tropical greenery"
  - "Experience the only place in the Caribbean where you might need a jacket"
gradientColors: "from-green-900 via-emerald-800 to-teal-900"
relatedDestinations:
  - "constanza"
  - "cabarete"
faqItems:
  - { question: "How long does it take to climb Pico Duarte?", answer: "The most popular route from La Ciénaga takes two to three days round trip, covering about 46 kilometers. Day one is a 23-kilometer hike to the base camp at La Compartición. Day two is the summit push (early morning) and return to camp or all the way out. A guide and mule are required — expect to pay RD$12,000-25,000 (~$205-$425 USD) per person for a full package including guide, mule, food, and camping gear." }
...
affiliatePicks:
  - name: "Jarabacoa River Club"
    type: "hotel"
    price: "RD$5,500/night (~$94 USD)"
    personalNote: "Set along the river with gorgeous mountain views. The rooms are simple but clean, and falling asleep to the sound of rushing water is hard to beat. The restaurant on-site is solid too."
    affiliateUrl: "#"
  - name: "Rancho Baiguate Adventure Center"
    type: "activity"
    price: "RD$3,500 (~$60 USD) for rafting"
    personalNote: "The most established outfitter in Jarabacoa. They run rafting, canyoning, horseback riding, and Pico Duarte treks. Equipment is well-maintained and guides are experienced. Book the rafting — it is the best single activity in town."
    affiliateUrl: "#"
  - name: "Aroma de la Montaña"
    type: "restaurant"
    price: "RD$600-1,200 (~$10-$20 USD)"
    personalNote: "Elevated Dominican cuisine in a cozy mountain setting. The goat stew and fresh trout are both excellent. Eat on the terrace if weather allows."
    affiliateUrl: "#"
