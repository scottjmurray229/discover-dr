...
heroImage: ""
tagline: "The Kiteboarding Capital of the Caribbean"
region: "north-coast"
...
budgetPerDay:
  ...
  midRange: 7500
  luxury: 20000
gettingThere: "Fly into Gregorio Luperón International Airport (POP) in Puerto Plata, then take a 20-minute taxi or shared van east along the coastal road to Cabarete. From Santo Domingo, it is about a 3.5-hour drive via Highway 5 north."
essentials:
  - { icon: "🌡️", label: "Climate", value: "Tropical — warm year-round, steady trade winds" }
  - { icon: "💵", label: "Budget", value: "RD$2,500-20,000/day (~$42-$340 USD)" }
  - { icon: "🗣️", label: "Language", value: "Spanish (English widely spoken)" }
  - { icon: "🌊", label: "Wind Season", value: "Peak winds January-March and June-July" }
highlights:
  - "Kitesurf or windsurf at Kite Beach, one of the top spots on the planet for wind sports"
  - "Walk barefoot along Cabarete Bay as the sun sets behind the beach bars"
  - "Explore the hidden freshwater lagoon at Cabarete Caves just outside town"
  - "Catch a wave at Encuentro Beach, the north coast's best surf break"
  - "Hike through El Choco National Park to caves, lagoons, and limestone formations"
gradientColors: "from-cyan-900 via-teal-800 to-blue-900"
relatedDestinations:
  - "las-terrenas"
  - "jarabacoa"
faqItems:
  - { question: "Do I need kiting experience to enjoy Cabarete?", answer: "Not at all. Cabarete has dozens of certified kite and windsurf schools with beginner courses that run two to four days. Flat-water lagoons near Kite Beach provide safe learning conditions. Most schools charge RD$15,000-20,000 (~$255-$340 USD) for a full beginner package including equipment." }
...
affiliatePicks:
  - name: "Velero Beach Resort"
    type: "hotel"
    price: "RD$8,500/night (~$145 USD)"
    personalNote: "Right on Cabarete Bay with a pool and solid breakfast included. The beachfront rooms are worth the upgrade — you wake up to the sound of waves."
    affiliateUrl: "#"
  - name: "Kite Club Cabarete"
    type: "activity"
    price: "RD$17,500 (~$300 USD) for 3-day course"
    personalNote: "The instructors here are IKO-certified and genuinely patient with beginners. Equipment is well-maintained and they provide GoPro footage of your sessions."
    affiliateUrl: "#"
  - name: "Cabarete Coffee Company"
    type: "restaurant"
    price: "RD$350-600 (~$6-$10 USD)"
    personalNote: "Best coffee in town, hands down. They roast Dominican beans on-site and the breakfast burritos are enormous."
    affiliateUrl: "#"
