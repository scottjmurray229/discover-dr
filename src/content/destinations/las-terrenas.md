...
heroImage: ""
tagline: "Caribbean Soul, European Flair"
region: "interior"
...
budgetPerDay:
  ...
  midRange: 7000
  luxury: 18000
gettingThere: "Fly into El Catey International Airport (AZS) on the Samaná Peninsula, just 25 minutes from Las Terrenas. Alternatively, drive from Santo Domingo (2.5-3 hours) via the Samaná Highway, a modern toll road that cuts through the mountains to the peninsula. From the north coast, it is about 3 hours via Nagua."
essentials:
  - { icon: "🌡️", label: "Climate", value: "Tropical — warm and humid, afternoon showers common" }
  - { icon: "💵", label: "Budget", value: "RD$2,200-18,000/day (~$37-$307 USD)" }
  - { icon: "🗣️", label: "Language", value: "Spanish and French widely spoken, English common" }
  - { icon: "🐋", label: "Whale Season", value: "January through March — humpback whale watching" }
highlights:
  - "Sink your toes into the golden sand at Playa Bonita, one of the most photogenic beaches in the country"
  - "Watch humpback whales breach and play in Samaná Bay from January through March"
  - "Dine at French bistros, Italian trattorias, and beachfront fish shacks all within walking distance"
  - "Explore the palm-fringed coastline on a scooter, stopping at hidden coves and quiet beaches"
  - "Experience a uniquely international Caribbean town where Dominican, French, and Italian cultures blend seamlessly"
gradientColors: "from-sky-900 via-blue-800 to-indigo-900"
relatedDestinations:
  - "cabarete"
  - "barahona"
faqItems:
  - { question: "Why do so many Europeans live in Las Terrenas?", answer: "The French and Italian expat presence dates to the 1970s and 1980s, when European backpackers discovered the then-remote peninsula and some never left. They opened restaurants, hotels, and businesses, creating a community that blended European culinary and cultural sensibilities with Dominican Caribbean life. Today, Las Terrenas has one of the largest French-speaking populations outside of France in the Caribbean. The result is a town with exceptional international dining, a cosmopolitan social scene, and a laid-back bilingual atmosphere." }
...
affiliatePicks:
  - name: "Hotel Alisei"
    type: "hotel"
    price: "RD$7,500/night (~$128 USD)"
    personalNote: "Beachfront location with a big pool and direct access to Playa Las Terrenas. The rooms are comfortable, the breakfast buffet is solid, and you can walk to everything in town. Best value in the mid-range category."
    affiliateUrl: "#"
  - name: "Whale Watching Samaná Tour"
    type: "tour"
    price: "RD$5,000 (~$85 USD) per person"
    personalNote: "A half-day trip that departs from the Samaná harbor. The boats are comfortable, the guides knowledgeable, and in February you will see whales. I saw mothers with calves, breaching males, and tail slaps within the first hour. Unforgettable."
    affiliateUrl: "#"
  - name: "La Terrasse Restaurant"
    type: "restaurant"
    price: "RD$800-1,800 (~$14-$31 USD)"
    personalNote: "French-run bistro with a menu that changes based on what the fishermen bring in. The tuna tartare and grilled lobster are both exceptional. Eat on the terrace overlooking the main street and people-watch."
    affiliateUrl: "#"
