...
budgetPerDay:
  ...
  midRange: 160
  luxury: 600
gettingThere: "Fly into La Romana International Airport (LRM), which receives limited direct flights, or into Punta Cana (PUJ), a 1-hour drive east, or Santo Domingo (SDQ), a 1.5-hour drive west. Casa de Campo has its own private airport. Buses connect La Romana to Santo Domingo (2 hours, RD$400 / ~$7 USD) and Punta Cana (1.5 hours). Taxis between La Romana and Bayahibe cost RD$1,200-1,800 (~$20-30 USD)."
essentials:
  - { icon: "🌡️", label: "Climate", value: "Tropical — warm and relatively dry, 76-88°F" }
  - { icon: "💵", label: "Budget", value: "RD$2,400-36,000 (~$40-600 USD)/day" }
  - { icon: "🗣️", label: "Language", value: "Spanish (English at resorts and tour companies)" }
  - { icon: "🪙", label: "Currency", value: "DOP (RD$), USD widely accepted in tourist areas" }
highlights:
  - "Wander the cobblestone streets of Altos de Chavon, a recreated Mediterranean village perched above the Chavon River gorge"
  - "Escape to Isla Saona's pristine white sand beaches and natural swimming pools by catamaran"
  - "Snorkel the coral walls of Catalina Island, one of the best underwater sites in the Dominican Republic"
relatedDestinations:
  - "punta-cana"
  - "santo-domingo"
faqItems:
  - { question: "Do I need to stay at Casa de Campo to visit Altos de Chavon?", answer: "No. Altos de Chavon is open to the public and does not require a stay at Casa de Campo. You can visit independently by taxi or rental car. There is a small entry fee at the gate for non-resort guests, typically around RD$600-900 (~$10-15 USD). The village, amphitheatre, and river views are fully accessible." }
  - { question: "Is La Romana or Punta Cana better for a beach vacation?", answer: "It depends on your priorities. Punta Cana has better beaches directly on the resort properties. La Romana has Altos de Chavon, easier access to Isla Saona and Catalina Island, and a more varied experience that includes culture alongside beach time. La Romana is also less crowded and slightly more affordable outside of Casa de Campo." }
  - { question: "What is the best way to visit Isla Saona?", answer: "Most visitors take a full-day catamaran or speedboat tour from Bayahibe, about 25 minutes east of La Romana. Tours include transportation, lunch on the island, a stop at the natural pool, and drinks. Expect to pay RD$4,200-7,200 (~$70-120 USD). Speedboats are faster and rougher; catamarans are slower and more comfortable. Book directly with operators in Bayahibe for the best prices." }
  - { question: "What are the Padre Nuestro cenotes?", answer: "A system of freshwater cenotes (natural limestone pools) accessible via a trail near Bayahibe. The trail also passes Taino cave paintings and tropical forest before reaching pools you can swim in. It is one of the most underrated experiences in the La Romana area and sees a fraction of the crowds that Isla Saona attracts. Hire a local guide in Bayahibe — the trail markings are minimal and the guide adds significant cultural context." }
  - { question: "How far is La Romana from Punta Cana?", answer: "Approximately 1 hour by car (75 kilometers) via the coastal highway. Many travelers combine both destinations — two nights in La Romana, two to three in Punta Cana (or vice versa) — making for a well-rounded east coast trip that includes culture (Altos de Chavon), island beaches (Saona, Catalina), and resort beach time (Punta Cana). Taxis charge RD$4,000-5,000 (~$68-85 USD) one way." }
  - { question: "Can I visit La Romana without staying at Casa de Campo?", answer: "Absolutely. Casa de Campo is a world-class resort but carries world-class prices — rooms start at $500+ USD per night. Bayahibe village offers far better value with small hotels and guesthouses at RD$3,000-6,000 (~$51-102 USD) per night. You can still visit Altos de Chavon (paying a gate entry fee), do all the island and dive excursions, and eat at the same local restaurants. The resort experience is optional, not required." }
  - { question: "Is La Romana good for scuba diving?", answer: "Excellent. Catalina Island has one of the best dive sites in the Dominican Republic — the Wall at Catalina is a dramatic coral drop-off with clear water and significant marine life including sea turtles, eagle rays, and reef sharks. Several dive operators in Bayahibe run daily trips. Expect to pay RD$3,500-5,000 (~$60-85 USD) for a two-tank dive. Certification courses are also available." }
affiliatePicks:
  - name: "Isla Saona Full-Day Catamaran"
    type: "tour"
    price: "RD$5,400 (~$90 USD)"
    personalNote: "The catamaran ride is part of the experience. Music, rum, and dancing on the way to paradise. Book the morning departure for calmer seas."
    affiliateUrl: "#"
  - name: "Bayahibe Dive Hotel"
    type: "hotel"
    price: "RD$4,800 (~$80 USD)"
    personalNote: "Small dive-focused hotel in Bayahibe village. Walking distance to the boat docks and local restaurants. Clean, friendly, no pretension."
    affiliateUrl: "#"
  - name: "Catalina Island Snorkel Trip"
    type: "activity"
    price: "RD$4,200 (~$70 USD)"
    personalNote: "Better snorkeling than Saona, fewer crowds, and a beautiful beach. The underwater wall is spectacular for confident swimmers."
    affiliateUrl: "#"
  - name: "Altos de Chavon Sunset Experience"
    type: "activity"
    price: "RD$1,200 (~$20 USD)"
    personalNote: "Self-guided visit timed for late afternoon. The light on the stone at sunset is unforgettable. Grab dinner at one of the village restaurants."
    affiliateUrl: "#"
...
I came to La Romana expecting a smaller, quieter version of Punta Cana -- resort beaches, all-inclusive buffets, maybe a boat trip. What I found was something genuinely different. This stretch of the Dominican southeast coast has a personality all its own, shaped by a remarkable artists' village perched above a river gorge, a luxury resort that operates like a small country, two of the Caribbean's most beautiful islands just offshore, and a local fishing village that feels untouched by the tourism machine next door.

La Romana the city is a working Dominican town of about 130,000 people, centred on the sugar industry that has defined this region for generations. The massive Central Romana sugar mill still operates at the edge of town, and the surrounding cane fields stretch to the horizon. This is not a place that was built for tourists. Tourism arrived because of one visionary project -- Casa de Campo -- and the attractions that grew around it. That origin gives La Romana an interesting tension between extreme luxury and everyday Dominican reality that I found more compelling than either would be on its own.

## Altos de Chavon: The Hilltop Village

Altos de Chavon is the most improbable attraction in the Dominican Republic, and possibly the most beautiful. Perched on a cliff 90 metres above the Chavon River, this recreated 16th-century Mediterranean village was built between 1976 and 1982 by the Casa de Campo resort's original developer, Charles Bluhdorn, as a cultural and artistic centre. Dominican craftsmen, working with Italian architect Roberto Copa, hand-carved every stone, laid every cobblestone, and fitted every tile to create a village that looks like it has been standing for centuries.

The result is either magnificently eccentric or magnificently beautiful, and I think it is both. The cobblestone streets wind between coral stone buildings housing art galleries, artisan workshops, a design school affiliated with the Parsons School of Design in New York, the Archaeological Regional Museum, and the Church of St. Stanislaus, which contains the ashes of the patron saint of Poland (donated by the Vatican -- another detail that seems improbable until you are standing in the church looking at the altar).

### The Amphitheatre

The crown jewel of Altos de Chavon is its 5,000-seat Grecian-style amphitheatre, carved into the hillside overlooking the Chavon River gorge. Frank Sinatra inaugurated it with a concert in 1982. Since then, everyone from Sting to Juan Luis Guerra to Andrea Bocelli has performed here. Even empty, the amphitheatre is spectacular -- the acoustics are superb, the views of the river and jungle below are dramatic, and the sense of scale is impressive for something so remote.

I visited Altos de Chavon in the late afternoon, and the light at that hour was extraordinary. The coral stone turned golden, the shadows lengthened across the cobblestones, and the Chavon River below caught the last of the sun. I walked through the galleries, watched a ceramics artist at work in one of the workshops, and stood at the edge of the cliff watching the river turn from green to silver as the light faded. *Que lugar tan increible* -- what an incredible place. Even the locals who work there seem to feel it.
...
The standard day trip is an institution. You board a catamaran or speedboat in Bayahibe, motor through turquoise water past mangrove islands, stop at the *piscina natural* (natural pool) -- a waist-deep sandbar in the middle of the sea where vendors wade out with trays of rum and fresh fruit -- and then continue to the island itself. The beach at Isla Saona is everything the photographs promise: white sand, coconut palms, warm shallow water extending far from shore, and that particular shade of Caribbean blue that seems like it should not exist in nature.
...
The snorkeling at Catalina is significantly better than at Saona. The island features a wall dive site called "The Wall" that drops from shallow reef to deep blue in a dramatic underwater cliff face. Even from the surface with a snorkel, you can peer over the edge and see coral formations, sea fans, parrotfish, angelfish, barracuda, and occasionally nurse sharks cruising the deeper water. It is the best snorkeling I found in the Dominican Republic.

The beach is lovely -- white sand, calm water, shaded by sea grapes and palms. Several tour operators offer combined snorkeling and beach day trips for RD$4,200-6,000 (~$70-100 USD) including lunch and equipment. The afternoon trips tend to be less crowded than the morning ones.
...
La Romana sits perfectly between Punta Cana (1 hour east) and Santo Domingo (1.5 hours west), making it an excellent middle stop on an east coast itinerary. Two nights in La Romana gives you time for one island excursion, a visit to Altos de Chavon, and an evening in Bayahibe. Three nights lets you add the second island or a day of diving. The contrast between La Romana's cultural depth and Punta Cana's beach perfection makes combining the two particularly rewarding.

<div class="scott-tips">

### Scott's Tips for La Romana

1. **Visit Altos de Chavon at sunset.** The late afternoon light transforms the coral stone into gold, and the evening atmosphere in the village is magical. Have a drink on the terrace, watch the light change over the Chavon River, and then stay for dinner.

2. **Choose Catalina over Saona if snorkeling matters.** Saona has the more famous beach, but Catalina has vastly superior underwater life. If you can only do one island trip, consider what matters more to you -- beach perfection or marine exploration.

3. **Stay in Bayahibe, not in La Romana town.** The village is more atmospheric, closer to the boat departures, and surrounded by good restaurants. The walk to the beach takes two minutes. La Romana town is functional but not scenic.

4. **Book island tours directly in Bayahibe.** Walk to the boat dock area and negotiate with operators directly. You will pay 30 to 50 percent less than booking through a resort or hotel tour desk. Morning departures get calmer water and less crowded beaches.

5. **Do not skip the Padre Nuestro cenotes.** This underrated trail near Bayahibe offers swimming in freshwater cenotes, Taino cave art, and tropical forest hiking without the crowds. Hire a local guide for the full experience.

6. **Eat lobster in Bayahibe.** The village restaurants serve lobster fresh from the morning catch at a fraction of resort prices. A whole grilled lobster dinner with sides and beer for RD$1,500 (~$25 USD) is one of the best value meals in the Dominican Republic.
