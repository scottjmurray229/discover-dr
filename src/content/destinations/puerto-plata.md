...
budgetPerDay:
  ...
  midRange: 110
  luxury: 320
gettingThere: "Fly into Gregorio Luperon International Airport (POP), 15 minutes from the city centre. Direct flights from several US and Canadian cities, plus charter flights from Europe. Caribe Tours and Metro buses connect Puerto Plata to Santo Domingo (4 hours, RD$500 / ~$8 USD) and Santiago (1.5 hours, RD$250 / ~$4 USD). Taxis from the airport cost RD$1,200-1,800 (~$20-30 USD)."
essentials:
  - { icon: "🌡️", label: "Climate", value: "Tropical — warm and humid, 75-88°F" }
  - { icon: "💵", label: "Budget", value: "RD$2,100-19,200 (~$35-320 USD)/day" }
  - { icon: "🗣️", label: "Language", value: "Spanish (English limited outside resorts)" }
  - { icon: "🪙", label: "Currency", value: "DOP (RD$), USD accepted at some hotels" }
highlights:
  - "Ride the only cable car in the Caribbean to the summit of Pico Isabel de Torres for panoramic views and a botanical garden"
  - "Trek through 27 natural waterfall pools at the 27 Charcos de Damajagua, swimming, sliding, and jumping through limestone canyons"
  - "Walk through the Victorian gingerbread houses of the city centre, relics of Puerto Plata's 19th-century tobacco boom"
relatedDestinations:
  - "samana"
  - "santo-domingo"
faqItems:
  - { question: "Is Puerto Plata still relevant or has it been replaced by Punta Cana?", answer: "Puerto Plata was the Dominican Republic's first major resort destination in the 1980s, and while Punta Cana has taken the spotlight, Puerto Plata offers something Punta Cana cannot: authentic Dominican culture within walking distance of the beach. The city has real history, real neighbourhoods, and real life happening around the tourist areas. It is also significantly cheaper." }
  - { question: "What are the 27 Charcos de Damajagua?", answer: "A series of 27 natural waterfalls and plunge pools formed by limestone terraces in the hills south of Puerto Plata. You hike upstream and then descend through the pools by jumping, sliding, and swimming. Most tours cover 7 or 12 charcos. The full 27 requires serious fitness and takes 4-5 hours. It is the most exhilarating outdoor activity in the Dominican Republic." }
  - { question: "How does the north coast compare to the east coast?", answer: "The north coast gets more rain, slightly cooler temperatures, and has rougher surf than the east coast. The trade-off is greener landscapes, more authentic Dominican towns, far fewer tourists, and significantly lower prices. If you want resort perfection, go east. If you want adventure and culture, come north." }
  - { question: "What is amber and why is the Dominican Republic known for it?", answer: "Dominican amber is fossilized tree resin from the extinct Hymenaea protera tree, millions of years old and found predominantly in the mountains behind Puerto Plata. It is prized for its clarity and for frequently containing ancient insects, plant matter, and other inclusions preserved in perfect detail. Dominican amber is among the finest in the world — lighter in color and more transparent than Baltic amber, and significantly rarer. The Amber Museum in Puerto Plata has the best collection and the most reliable shop." }
  - { question: "Is Puerto Plata safe for tourists?", answer: "Puerto Plata is generally safe in the tourist areas, Victorian quarter, Malecon, and established restaurant zones. Standard urban awareness applies: avoid displaying expensive jewelry or electronics, use ATMs inside banks, and stick to populated streets after dark. The resort strip at Playa Dorada operates in a self-contained environment with minimal safety concerns. Outside the main tourist areas, exercise more caution and ask hotel staff for current advice." }
  - { question: "What is the best beach near Puerto Plata?", answer: "Playa Dorada, the main resort beach, is convenient but crowded with all-inclusive guests. Playa Cofresí (5 km west) is more local and pleasant. Playa Sosúa (30 minutes east) has calm, protected waters and good snorkeling with a relaxed atmosphere. Playa Grande (1.5 hours east) is considered one of the best beaches on the north coast — dramatic, relatively uncrowded, and strikingly beautiful." }
  - { question: "How long should I spend in Puerto Plata?", answer: "Three nights is a good minimum. Day one: cable car to Isabel de Torres and the Victorian quarter. Day two: 27 Charcos de Damajagua (full day). Day three: Amber Museum, Malecon, local food, and relaxing. A fourth night lets you add Playa Sosúa or start day trips toward Cabarete and the Samaná Peninsula. Puerto Plata also serves as a base for exploring the entire north coast." }
affiliatePicks:
  - name: "27 Charcos Full Adventure"
    type: "activity"
    price: "RD$3,000 (~$50 USD)"
    personalNote: "The 12-charco option hits the best waterfalls without being exhausting. Bring water shoes and a sense of adventure."
    affiliateUrl: "#"
  - name: "Puerto Plata Historic Hotel"
    type: "hotel"
    price: "RD$4,200 (~$70 USD)"
    personalNote: "Restored Victorian building in the city centre. Character and charm that no chain resort can match."
    affiliateUrl: "#"
  - name: "Amber Museum & City Walking Tour"
    type: "tour"
    price: "RD$1,500 (~$25 USD)"
    personalNote: "Two hours through the historic centre with stops at the Amber Museum, Victorian quarter, and central park. Great orientation."
    affiliateUrl: "#"
...
Bring water shoes or sport sandals with ankle straps -- regular flip-flops will not survive the hike. Leave your phone and camera at the lockers (available at the entrance) unless you have a waterproof action camera. Bring cash for the entrance fee. The small restaurant at the trailhead serves cold drinks and Dominican food after the excursion, which you will need.

## The Victorian Quarter

Puerto Plata's city centre holds a surprise that most beach-bound tourists never discover: a collection of Victorian-era gingerbread houses that constitute one of the finest examples of Caribbean wooden architecture in the region. These ornate, pastel-coloured wooden buildings were constructed during the late 19th century, when Puerto Plata's tobacco trade made it the wealthiest city in the Dominican Republic.
...
The museum also serves as a shop, and the prices are fair. If you want to buy amber jewellery in the Dominican Republic, this is a trustworthy place to do it. Beware of counterfeit amber sold by street vendors -- the museum staff will explain how to identify the real thing. Entry costs RD$250 (~$4 USD).

## The Malecon and City Life

Puerto Plata's Malecon is not glamorous. There is no polished promenade or line of trendy restaurants. What there is, instead, is Dominican life unfolding at the edge of the sea. Fishermen mend nets along the seawall. Families gather in the evening breeze. Vendors sell *empanadas de yuca* and *batidas de lechosa* (papaya milkshakes) from carts. The Fortaleza San Felipe, a 16th-century Spanish fortress, anchors the western end of the waterfront and houses a small museum of colonial artefacts.
...
2. **Ride the cable car on a clear morning.** Check the summit visibility before going -- some hotels and tour operators can tell you if clouds are sitting on the mountain. Morning offers the best odds of clear views.
...
4. **Stay in the city, not the resort strip.** Puerto Plata's charm is its authenticity. Staying in a Victorian guesthouse in the city centre puts you in the middle of real Dominican life. The Playa Dorada resorts are fine, but you can find that experience anywhere. You cannot find this neighbourhood anywhere else.
